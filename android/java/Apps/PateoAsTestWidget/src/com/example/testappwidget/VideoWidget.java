 ...
 *
 */
public class VideoWidget extends AbstractBaseWidget {
	static final String PACKAGE_NAME = "com.pateo.video";
	static final String CLASS_NAME = "com.pateo.video.AppMain";
	private int layout = R.layout.video_layout;
	private int view_id = R.id.video_view;
	private int drawable_id = R.drawable.video;
