 ...
 *
 */
public class SettingsWidget extends AbstractBaseWidget {
	static final String PACKAGE_NAME = "com.pateo.as.settings";
	static final String CLASS_NAME = "com.pateo.as.settings.activity.SettingActivity";
	private int layout = R.layout.settings_layout;
	private int view_id = R.id.settings_view;
	private int drawable_id = R.drawable.settings;
