 ...
 *
 */
public class PhotoWidget extends AbstractBaseWidget {
	static final String PACKAGE_NAME = "com.pateo.as.photo";
	static final String CLASS_NAME = "com.pateo.as.photo.activity.MainActivity";
	private int layout = R.layout.photo_layout;
	private int view_id = R.id.photo_view;
	private int drawable_id = R.drawable.photo;
