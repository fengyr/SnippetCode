...
static RootInfo g_roots[] = {
    { "CACHE:", "/dev/block/mmcblk0p2", NULL, "cache", "/cache", "ext3" },
    { "DATA:", "/dev/block/mmcblk0p3", NULL, "userdata", "/data", "ext3" },
    { "SYSTEM:", "/dev/block/mmcblk0p1", NULL, "system", "/system", "ext3" },
    { "SDCARD:", "/dev/block/mmcblk0p5", NULL, NULL, "/sdcard", "vfat" }, //for inand first zone ,store the update.zip
    { "SDCARD1:", "/dev/block/mmcblk1p1", "/dev/block/mmcblk1", NULL, "/sdcard1", "vfat" }, //externel sdcard
};
...
//TODO: handle other device types (sdcard, etc.)
	if (!strcmp(info->filesystem, "vfat"))  {
		char* argv[10];
		argv[0] = "newfs_msdos";
		argv[1] = "-F";
		argv[2] = "32";
