...
#define MAX_COLS 600 / CHAR_WIDTH 
#define MAX_ROWS 1024 / CHAR_HEIGHT
...
static const struct { gr_surface* surface; const char *name; } BITMAPS[] = {
    ...
    { &gBackgroundIcon[BACKGROUND_ICON_LOW_BT],      "icon_low_bt" },
    { &gBackgroundIcon[BACKGROUND_ICON_SUCCESS],      "icon_success" },/* <--LH_SWRD_CL1_Mervins@2011.09.19 --> *//* add icon of success.*/
...
static void *input_thread(void *cookie)
{
    ...
    for (;;) {
        ...
        do {
            ev_get(&ev, 0);
			if (ev.value == 1) {/* <--LH_SWRD_CL1_Mervins@2011.08.23--> */
				ev.value = 0;
			} else if (ev.value == 0) {
				ev.value = 1;
			}
...
#endif
/* <--LH_SWRD_CL1_Mervins@2011.09.19:for touch calibiraton use. --> */
void ui_print_tp(const char *fmt, ...)
{
    char buf[256];
    va_list ap;
    va_start(ap, fmt);
