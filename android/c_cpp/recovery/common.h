...
enum {
  ...
  BACKGROUND_ICON_LOW_BT,
  BACKGROUND_ICON_SUCCESS,/* <--LH_SWRD_CL1_Mervins@2011.09.19:add icon for install success. --> */
...
enum {
	BOOT_NORMAL = 0x0,
	BOOT_PRODUCT_LINE,
	BOOT_SYSTEM_UPGRADE_KEY,
	BOOT_FACTORY_RESET_KEY,
	BOOT_SYSTEM_UPGRADE_OTA,
	BOOT_FACTORY_RESET_OTA,
	BOOT_MODE_COUNT
};
...
// recovery_status == 0, indicates that error doesn't present during recovery 
// recovery_status != 0, indicates that error presents during recovery 
int recovery_status;
