...
def tcp():
    ...
    s.send(getData(0, "type_handler_1"))
    # s.sendto("hello world", (HOST, PORT));
    print s.recv(4096)
    time.sleep(0.5)

    while True:
        s.send(getData(2, "hello wrold"))
        print s.recv(4096)
        ...
        s.send(getData(2, '1'*1012))
        print s.recv(4096)

        s.send(getData(2, '1'*1013))
        print s.recv(4096)

        s.send(getData(2, '1'*1014))
        print s.recv(4096)
