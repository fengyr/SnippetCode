...
int main(int argc,char** argv)
{
    ...
    while(true)
    {
        ...
        Descriptor Img_Des;
        calcImagevalue(Img_ColorSep, Img_Des, 1);
        ...
        if(classifiertype == 0)
            typevalue = CL_ProcessSep(Img_ColorSep, Img_Des, FrameCounter, MaxClass, TrainMode);
        else if(classifiertype == 1)
            typevalue = KNN_ProcessSep(Img_ColorSep, Img_Des, FrameCounter, MaxClass, TrainMode);
