...
void test_rb_tree_insert_lookup(void)
{
	...
	for (i=0; i<NUM_TEST_VALUES; ++i) {
		...
		value = rb_tree_node_key(node);
		assert(*((int*)value) == i);
		value = (int*) rb_tree_node_value(node);
		assert(*((int*)value) == i);
	}
...
void test_rb_tree_child(void)
{
	...
	assert(rb_tree_node_child(root, (RBTreeNodeSide)-1) == NULL);
	assert(rb_tree_node_child(root, (RBTreeNodeSide)10000) == NULL);
	assert(rb_tree_node_child(root, (RBTreeNodeSide)2) == NULL);
	assert(rb_tree_node_child(root, (RBTreeNodeSide)-100000) == NULL);
